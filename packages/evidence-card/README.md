...
> attestation, since 2026-09-10: `npm i @affiant/evidence-card@alpha`. `latest` and
> `alpha` both point at `0.1.0-alpha.1`. Publishing is a separate, deliberate step — a
> workflow a maintainer dispatches by hand, which defaults to a dry run.
