...
| [`@affiant/core`](packages/core)                             | the gate — Affidavit capture, interceptors, projection, policy, the Docket, decisions       | `0.1.0-alpha.1` on npm under the `alpha` dist-tag — `npm i @affiant/core@alpha`; complete for Sequences A and C |
