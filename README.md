...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [`@affiant/contract`](packages/contract)                     | the wire types and a vendorable JSON Schema, pinned to a protocol tag                       | `0.1.0-alpha.0` on npm, `main` at `0.1.0-alpha.1` (publish pending) — `npm i @affiant/contract@alpha`                             |
| [`@affiant/evidence-card`](packages/evidence-card)           | `<affiant-evidence-card>`, a framework-agnostic Web Component that renders an Evidence Card | `0.1.0-alpha.0` on npm, `main` at `0.1.0-alpha.1` (publish pending) — `npm i @affiant/evidence-card@alpha`                        |
| [`@affiant/core`](packages/core)                             | the gate — Affidavit capture, interceptors, projection, policy, the Docket, decisions       | `0.1.0-alpha.0` on npm, `main` at `0.1.0-alpha.1` (publish pending) — `npm i @affiant/core@alpha`; complete for Sequences A and C |
